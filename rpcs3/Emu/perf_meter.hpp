...
public:
	...
	// Sampling utils::get_tsc() is a serializing system-register read on
	// ARM64. Hot guest atomic and DMA paths use this constructor when the
	// timestamp is only consumed by the performance report.
