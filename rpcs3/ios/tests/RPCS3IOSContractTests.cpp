...
int main()
{
	...
	static_assert(RPCS3_IOS_ABI_VERSION == 30);
	...
	static_assert(sizeof(rpcs3_ios_savestate_info) == 32);
	static_assert(sizeof(rpcs3_ios_trophy_info) == 80);
	static_assert(RPCS3_IOS_TROPHY_GRADE_PLATINUM == 1);
